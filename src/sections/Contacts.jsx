...
console.log("Public Key:", import.meta.env.VITE_APP_EMAILJS_PUBLIC_KEY);
  ...
  return (
    <section id="contacts" className="flex-center section-padding">
      <div className="w-full h-full md:px-10 px-5">
        <TitleHeader
          title="Get in Touch – Let’s Connect"
          sub="Have questions or wanna give me a job?"
        />
              ...
              >
                <div>
                  ...
                  <input
                    ...
                    placeholder="Kindly tell me your name"
                    required
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    value={form.email}
                    onChange={handleChange}
                    placeholder="Which mail should I respond to?"
                    required
                  />
                </div>
